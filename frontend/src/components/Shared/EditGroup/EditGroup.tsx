...
import { TextField, CircularProgress, FormGroupClassKey } from '@material-ui/core';
...
const EditGroup: React.FC<Props> = props => {
  ...
  return (
    <>
      <div className={styles.backdrop} onClick={() => dispatch({ type: 'GROUP MODAL', payload: { modal: null } })}></div>
